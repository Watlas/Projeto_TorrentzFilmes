...
public class Contrata {
    ...
    public Contrata(int contrato_iden, Date contrato_dataInicio, Date contrato_dataFim, boolean contrato_status, Usuario con_usuario_iden, Plano con_plano_iden) {
    ...
    public Plano getCon_plano_iden() {
        return con_plano_iden;
    }

    public void setCon_plano_iden(Plano con_plano_iden) {
        this.con_plano_iden = con_plano_iden;
    }
}
